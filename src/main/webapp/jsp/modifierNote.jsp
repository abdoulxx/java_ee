...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <h1 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Modifier une Note</h1>
        </div>
    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="matiere" name="matiere" class="form-select form-select-lg" required>
                                    ...
                                    <c:forEach items="${matieres}" var="m">
                                        <option value="${m}" ${note.matiere == m ? 'selected' : ''}>${m}</option>
                                    </c:forEach>
                                    <option value="Mathématiques" ${note.matiere == 'Mathématiques' ? 'selected' : ''}>Mathématiques</option>
                                    <option value="Programmation" ${note.matiere == 'Programmation' ? 'selected' : ''}>Programmation</option>
                                    <option value="Base de données" ${note.matiere == 'Base de données' ? 'selected' : ''}>Base de données</option>
                                    <option value="Réseaux" ${note.matiere == 'Réseaux' ? 'selected' : ''}>Réseaux</option>
                                    <option value="Algorithme" ${note.matiere == 'Algorithme' ? 'selected' : ''}>Algorithme</option>
                                    <option value="Systèmes d'exploitation" ${note.matiere == 'Systèmes d\'exploitation' ? 'selected' : ''}>Systèmes d'exploitation</option>
                                    <option value="Génie logiciel" ${note.matiere == 'Génie logiciel' ? 'selected' : ''}>Génie logiciel</option>
                                    <option value="Web" ${note.matiere == 'Web' ? 'selected' : ''}>Développement Web</option>
                                    <option value="Java EE ou .Net" ${note.matiere == 'Java EE ou .Net' ? 'selected' : ''}>Java EE ou .Net</option>
                                </select>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="semestre" name="semestre" class="form-select form-select-lg">
                                        ...
                                        <option value="7" ${note.semestre == 7 ? 'selected' : ''}>Semestre 7</option>
                                        <option value="8" ${note.semestre == 8 ? 'selected' : ''}>Semestre 8</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date"
                                           ...
                                           name="dateEvaluation"
                                           class="form-control form-control-lg"
                                           value="<fmt:formatDate value='${note.dateEvaluation}' pattern='yyyy-MM-dd'/>">
                                </div>
                            </div>
