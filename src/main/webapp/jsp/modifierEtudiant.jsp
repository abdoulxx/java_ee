...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <h1 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Modifier un Étudiant</h1>
        </div>
    </div>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">
                            <i class="bi bi-file-earmark-person me-2"></i>Informations de l'Étudiant
                        </h5>
                    </div>
                        ...
                        <form action="${pageContext.request.contextPath}/etudiants" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="filiere" name="filiere" class="form-select form-select-lg">
                                        ...
                                        <option value="MIAGE" ${etudiant.filiere == 'MIAGE' ? 'selected' : ''}>MIAGE</option>
                                        <option value="GI" ${etudiant.filiere == 'GI' ? 'selected' : ''}>GI (Génie Informatique)</option>
                                        <option value="Informatique" ${etudiant.filiere == 'Informatique' ? 'selected' : ''}>Informatique</option>
                                        <option value="Réseaux" ${etudiant.filiere == 'Réseaux' ? 'selected' : ''}>Réseaux et Télécommunications</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date"
                                       ...
                                       name="dateNaissance"
                                       class="form-control form-control-lg"
                                       value="<fmt:formatDate value='${etudiant.dateNaissance}' pattern='yyyy-MM-dd'/>">
                            </div>
